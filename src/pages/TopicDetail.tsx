                  ...
                  initialMessages={[
                    {
                      ...
                      content: `Welcome to ${topicDetails.title}! I'll be your guide through this topic. We'll explore core data structures, algorithms, and problem-solving techniques through a series of interactive problems.`
                    },
                    {
                      id: '2',
                      type: 'peer' as const,
                      content: `${topicDetails.title} concepts are used everywhere in software engineering and technical interviews. Super practical!`
                    },
                    {
                      id: '3',
                      type: 'teacher' as const,
                      content: `Let's start with our first question to test your understanding. Ready to begin?`
                    }
                  ]}
                />
              </div>
