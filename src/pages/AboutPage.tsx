  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <main className="container mx-auto px-4 py-32 sm:px-6 lg:px-8 space-y-16">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              We're passionate about helping students master complex subjects like 
        ...
        <section className="bg-slate-50/70 border border-slate-200/80 rounded-2xl p-8">
          <h2 className="text-3xl font-bold text-slate-900 mb-6 text-center">How We're Different</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 border border-slate-200/80 shadow-sm hover:border-blue-300 hover:shadow-lg hover:shadow-blue-500/5 transition-all">
              <div className="flex justify-center mb-4">
                <div className="p-3.5 rounded-2xl bg-blue-50 border border-blue-100">
                  <BrainCircuit className="w-8 h-8 text-blue-600" />
                </div>
              </div>
              <h3 className="text-xl font-bold text-slate-900 mb-2 text-center">Dual AI Perspective</h3>
            ...
            <div className="bg-white rounded-xl p-6 border border-slate-200/80 shadow-sm hover:border-blue-300 hover:shadow-lg hover:shadow-blue-500/5 transition-all">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2 text-center">Progressive Learning</h3>
              <p className="text-slate-600 text-center text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-xl p-6 border border-slate-200/80 shadow-sm hover:border-blue-300 hover:shadow-lg hover:shadow-blue-500/5 transition-all">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2 text-center">Practical Application</h3>
              <p className="text-slate-600 text-center text-sm leading-relaxed">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="bg-blue-50/70 border border-blue-100 rounded-2xl p-8 flex items-center justify-center order-last md:order-first">
            <div className="w-full max-w-md flex flex-col items-center">
              <Code className="w-20 h-20 text-blue-600 mb-4" />
              <h3 className="text-2xl font-bold text-slate-900 text-center">Built By Educators & Engineers</h3>
            </div>
          </div>
          <div>
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              Our experts in Computer Science have designed the curriculum to focus on 
