...
const TopicCard = ({ topic, className = '' }: TopicCardProps) => {
  ...
  return (
    <Link 
      ...
      className={`block p-6 rounded-xl glass-card transition-all hover:shadow-lg hover:scale-105 purple-glass ${className}`}
    >
      <div className="flex justify-between items-start">
        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-purple-100 text-purple-600 dark:bg-purple-900/30 dark:text-purple-400">
