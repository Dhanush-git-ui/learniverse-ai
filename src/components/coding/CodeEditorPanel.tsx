...
export default function CodeEditorPanel(props: CodeEditorPanelProps) {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-white dark:bg-slate-950">
      ...
      <div className="flex justify-between items-center px-4 py-2 bg-slate-50 dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800/80">
      ...
      <div className="flex-1 min-h-0 bg-white dark:bg-slate-950 p-1">
        <Editor
          ...
          className="rounded-xl overflow-hidden bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800"
        />
      </div>
      ...
      <div className="flex justify-between items-center px-4 py-3.5 bg-slate-50 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800/80">
        <span className="text-[10px] font-mono text-slate-400 dark:text-slate-500">Ctrl + Enter to Run</span>
        <div className="flex items-center space-x-2">
          <button 
            onClick={props.handleRunCode} 
            className="flex items-center space-x-1.5 px-4 py-2 rounded-xl text-xs font-semibold bg-white hover:bg-slate-100 dark:bg-slate-900 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-800 transition-all active:scale-[0.98]"
          >
