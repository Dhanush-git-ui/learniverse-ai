          ...
          <Panel defaultSize={35} minSize={25}>
            <div className="h-full overflow-y-auto p-5 bg-slate-50/30 dark:bg-slate-900/40 border-r border-slate-200 dark:border-slate-800/80">
              <ProblemDescriptionPanel 
                challenge={props.challenge} 
                algorithmText={props.algorithmText}
                setAlgorithmText={props.setAlgorithmText}
                timeComplexity={props.timeComplexity}
                setTimeComplexity={props.setTimeComplexity}
                spaceComplexity={props.spaceComplexity}
                setSpaceComplexity={props.setSpaceComplexity}
              />
            </div>
          </Panel>
          ...
          {aiPanelOpen && (
            <>
              ...
              <Panel defaultSize={20} minSize={15}>
                <div className="h-full bg-slate-50/20 dark:bg-slate-900/20 p-5 overflow-y-auto border-l border-slate-200 dark:border-slate-800/80">
                  <AiAssistantPanel 
                    challenge={props.challenge}
                    userCode={props.userCode}
