...
Learniverse AI is an interactive, state-of-the-art educational platform designed to help students master **Data Structures and Algorithms (DSA)**. 

Powered by a **Dual-Persona Retrieval-Augmented Generation (RAG)** pipeline, Learniverse AI pairs you with two distinct virtual mentors who ground their answers in academic textbooks to guide you through coding challenges and computer science concepts.
...
* **Dual-Persona Mentoring:**
  * **Teacher AI:** Provides structured, precise, step-by-step textbook explanations utilizing correct computer science terminology.
...
* **Grounded Textbook Reference (RAG):** Answers are strictly grounded in university-level reference material (such as *Open Data Structures*), preventing hallucinations.
* **Citations & Sources:** Every response lists the specific textbook chapters and sections referenced during generation.
* **Interactive Question Cards:** Solve topic-specific coding problems, get hints, and submit your answers for evaluation.
...
| **Generative LLM** | Google Gemini API (`gemini-3.5-flash`) |
...
2. **Context Retrieval:** `retriever.py` encodes the query using Google Gemini Embeddings API and queries the ChromaDB collection (`dsa_books`).
